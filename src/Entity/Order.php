...
class Order
{
    ...
    private ?string $stipe_session_id = null;
    ...
    public function getStipeSessionId(): ?string
    {
        return $this->stipe_session_id;
    }

    public function setStipeSessionId(?string $stipe_session_id): static
    {
